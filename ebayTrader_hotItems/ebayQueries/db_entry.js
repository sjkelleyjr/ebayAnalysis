...
exports.enterPricePoint = function(new_fixed,new_auction,used_fixed,used_auction,jsonPP){
        if(new_fixed){
          pricePoints_New_Fixed.findByKeyword(params.keywords,function(document){
            if(document.length == 0) {
              console.log('no price point for keyword ' + params.keywords);
        ...
        if(new_auction){
          pricePoints_New_Auction.findByKeyword(params.keywords,function(document){
            if(document.length == 0) {
              console.log('no price point for keyword ' + params.keywords);
        ...
        if(used_auction){
          pricePoints_Used_Auction.findByKeyword(params.keywords,function(document){
            if(document.length == 0) {
              console.log('no price point for keyword ' + params.keywords);
        ...
        if(used_fixed){
          pricePoints_Used_Fixed.findByKeyword(params.keywords,function(document){
            if(document.length == 0) {
              console.log('no price point for keyword ' + params.keywords);
